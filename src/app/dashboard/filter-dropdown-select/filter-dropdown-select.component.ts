...
export class FilterDropdownSelectComponent implements OnInit {
  ...
  changeStateRadio(idx: number){
    this.options.forEach((o,i)=>{
      if(i == idx){ this.options[i].active = true; }
