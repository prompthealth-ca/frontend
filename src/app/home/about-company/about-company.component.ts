...
const faqs: IFAQItem[] = [
  ...
  {q: 'What is known as a wellness company?', a: 'Brands in wellness which are not necessarily offered  by a wellness providers. It can range from Apps, products, services and resources that have an offering in one or more of the categories listed on PromptHealth.', opened: false,},
